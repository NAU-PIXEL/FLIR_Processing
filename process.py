...
def process_flir_image(input_dir, output_dir, height_source, filename):
    ...
    flir_image.default_distance = get_height(height_source, metadata)
    ...
    if thermal_image is not None:
        ...
        save_geotiff(os.path.join(output_dir, file_name_without_extension + '_thermal.tif'), thermal_image, metadata)
    ...
    if visible_image is not None:
        ...
        save_geotiff(os.path.join(output_dir, file_name_without_extension + '_visible.tif'), visible_image, metadata)

def save_geotiff(output_path, image_data, metadata):
...
if __name__ == "__main__":
    ...
    process_partial = partial(process_flir_image, input_directory, output_directory, height_source)
    if args.debug:
